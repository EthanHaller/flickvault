...
<head>
  ...
  <meta name="description" content="FlickVault Signup">
  <meta name="keywords" content="FlickVault Signup">
  <meta property="og:title" content="FlickVault Signup">
  <meta property="og:type" content="website">
  <meta property="og:image" content="">
  <meta property="og:url" content="https://cs4640.cs.virginia.edu/vgn2bh/flickvault/signup">
  <meta property="og:description" content="FlickVault Signup">
  <meta property="og:site_name" content="CS4640">

  <title>FlickVault | Signup</title>
...
<body>
    <div class="container mt-5">
		<h1 class="text-center pt-5 mb-5">Signup for FlickVault</h1>
    ...
    <h2 class="mt-5 mb-3">Signup</h2>
			...
			<button type="submit" class="btn mt-3 mb-5">Signup</button>
      <p>Already have an account?</p>
      <a href="?command=showLogin" class="mb-5">Login</a>
		</form>
    <?= $errorMessage ?>
	</div>
