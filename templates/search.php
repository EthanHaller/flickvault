...
<body>
    ...
    <div class="search-container filter">
        ...
        <div id="search-form-wrapper">
            <form id="search-form">
                <input type="email" class="form-control" id="searchinput" placeholder="Search">
                <button type="submit" class="btn nav-search">Search</button>
            </form>
        </div>

        <!-- Off-canvas Menu -->
        <div class="offcanvas offcanvas-end w-25 filter-menu" tabindex="-1" id="offcanvas" data-bs-theme="dark"
            ...
            <div id="filter-menu-body" class="offcanvas-body">
                <div class="filter-section">
                    ...
                    <div class="checkbox-group">
                        <label for="action" class="checkbox-item"><input type="checkbox" id="action" name="genre"
                                   value="action"> Action</label>
                        <label for="adventure" class="checkbox-item"><input type="checkbox" id="adventure" name="genre"
                                   value="adventure"> Adventure</label>
                        <label for="comedy" class="checkbox-item"><input type="checkbox" id="comedy" name="genre"
                                   value="comedy"> Comedy</label>
                        <label for="crime" class="checkbox-item"><input type="checkbox" id="crime" name="genre"
                                   value="crime"> Crime</label>
                        <label for="family" class="checkbox-item"><input type="checkbox" id="family" name="genre"
                    ...
                    <div id="star-rating">
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="star-rating-dropdown-lower" data-bs-toggle="dropdown" aria-expanded="false">
                                Min Star
                            </button>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button"
                                    id="star-rating-dropdown-upper" data-bs-toggle="dropdown" aria-expanded="false">
                                Max Star
                            </button>
        ...
        <!-- Filter & Sort button -->
        <button id="filter-button" class="btn nav-search" data-bs-toggle="offcanvas" data-bs-target="#offcanvas"
    ...
    <div class="search-results container">
        ...
        <div class="search-result mb-4">
            <img class="search-result-poster" src="https://image.tmdb.org/t/p/original/3bhkrj58Vtu7enYsRolD1fZdja1.jpg"
                 alt="Movie Poster">
